        ...
        <div class="table-responsive p-2" >
            ...
            <div class="ms-md-auto pe-md-3 col-lg-8 mx-auto my-4  d-flex align-items-center">
                <div dir="rtl" class="input-group border border-dark">
                    ...
                    <input type="text" class="form-control " wire:model.live='search' placeholder="ابحث ...">
                </div>
                

            </div>

        {{ $passports->links('vendor.livewire.bootstrap') }}
            <table dir="rtl" class="table mb-0 table-responsive">
                <thead>
                    <tr>
