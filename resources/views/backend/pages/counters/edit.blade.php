        ...
        <div class="mx-auto mb-4 col-lg-8 col-12 mb-md-0">
            <div class="card">
                <div dir="rtl" class="pb-0 card-header">
                    <div class="mb-3 row">
                        <div class="col-6">
                            <h6>تعديل عداد :- {{ $counter->titel }}</h6>
                            <p class="text-sm">
...
<a href="{{ route('counters') }}" class="btn bg-gradient-info btn-sm">عودة الى القائمة <i class="fa fa-arrow-left"></i></a>
                ...
                <form dir="rtl" class="p-4" method="POST" action="{{ route('counters.update',$counter->id) }}">
                    @csrf
                    @method('PUT')
        ...
        <div dir="l" class="mb-4 input-group">
                <div class="dropdown ">
                    ...
                    <div class="form-group">
                      ...
                      <input name="value" type="number" value="{{ old('value',$counter->value)}}" class="form-control" id="exampleFormControlTextarea1"  />
                    </div>
