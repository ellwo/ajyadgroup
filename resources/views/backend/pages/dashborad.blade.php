                            ...
                            <div class="mb-4 col-lg-6 mb-lg-0">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <p class="mb-5">من الألوان والبطاقات والطباعة إلى العناصر المعقدة ، ستجد
                                        الوثائق الكاملة.</p>
                                    <a class="mt-auto mb-0 text-dark font-weight-bold ps-1 icon-move-left"
                                        href="javascript:;">
                                        اقرأ المستندات
                        ...
                        <div class="timeline timeline-one-side">
                            <div class="mb-3 timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="mb-0 text-sm text-dark font-weight-bold">$2400, تغييرات في التصميم</h6>
                            ...
                            <div class="mb-3 timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="mb-0 text-sm text-dark font-weight-bold">مدفوعات الخادم لشهر أبريل</h6>
                            ...
                            <div class="mb-3 timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="mb-0 text-sm text-dark font-weight-bold">فتح الحزم من أجل التطوير</h6>
