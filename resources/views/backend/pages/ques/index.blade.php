...
<a href="{{ route('question.create') }}" class="btn bg-gradient-info btn-sm">اضافة خبر  <i class="fa fa-plus"></i></a>
                                        ...
                                        <div class="my-auto col-6 text-start">
                                            <div class="dropdown float-start ps-4">
                                                ...
                                                <ul class="px-2 py-3 dropdown-menu me-n4" aria-labelledby="dropdownTable">
                                                    <li><a class="dropdown-item border-radius-md " href="{{ route('question.edit',$p->id) }}">تعديل <i class="fa fa-edit"></i></a></li>
                                                    <li><a class="dropdown-item border-radius-md" target="_blanck" href="{{ route('question.show',$p->id) }}">عرض <i class="fa fa-eye"></i></a>
                                                    </li>

                                                    <li>
                                                        <form action="{{ route('question.destroy',$p) }}"
                                                         method="post">
                                                         @method('DELETE')
                                                         @csrf
