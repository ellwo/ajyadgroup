...
<button type="button" class="btn bg-gradient-info btn-sm">عودة الى القائمة <i class="fa fa-arrow-left"></i></button>
                ...
                <form dir="rtl" class="p-4" method="POST" action="{{ route('addresses.update',$ad) }}">
                     @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" required name="name" class="form-control"
                       id="exampleFormControlInput1" value="{{old('name',$ad->name) }}" placeholder="ادخل اسم الفرع">
                    ...
                    <div x-data='{"phones_count":0}' class="form-group  ">
                        ...
                        <div class="text-center flex">
                            ...
                            @foreach ($ad->phone??[] as $p)
                            <input type="text" value="{{ $p }}" required name="phone[]" class="form-control" id="exampleFormControlInput12"  placeholder="">
        ...
        <div dir="l" class="mb-4 input-group">
            <span onclick=" $(this).parent().removeClass('mb-4');$(this).parent().html('');" class="input-group-text bg-danger"><i class="fa-solid fa-remove "></i></span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required name="st_name"
                         class="form-control" id="exampleFormControlInput144"
                          value="{{old('st_name',
                          substr($ad->address,0,strpos($ad->address,'-'))
                          ) }}" placeholder="ادخل اسم الشارع الرئيسي">
                    ...
                    <div class="form-group">
                        ...
                        id="exampleFormControlInput100" value="{{old('address',

                        substr($ad->address,strpos($ad->address,'-')+1)) }}" placeholder="ادخل العنوان">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" dir="ltr"
                         name="map_link"
                          class="form-control"
                           id="exampleFormControlInput12" value="{{old('map_link',$ad->map_link??'#') }}" placeholder="ادخل الرابط الخاص بخرائط جوجل">
