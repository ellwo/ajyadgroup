...
'title'=>'ادارة الاخبار'  ])
 @section('content')
   ...
   <div class="py-4 container-fluid">
    <div class="my-4 row">
        <div class="mx-auto mb-4 col-lg-10 col-md-10 mb-md-0">
            <div class="card">
...
<a href="{{ route('posts.create') }}" class="btn bg-gradient-info btn-sm">اضافة خبر  <i class="fa fa-plus"></i></a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="px-2 py-1 ">
                                            <div>
                                              <img src="{{ $p->img }}" class="ml-2 avatar avatar-lg ">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                              <h6 class="m-2 text-xs ">{{ $p->titel }}</h6>
                                            </div>
                                          </div>
                                    ...
                                    <td dir="ltr" class="">
                                        ...
                                        <div class="my-auto col-6 text-start">
                                            <div class="dropdown float-start ps-4">
                                                <a class="p-4 cursor-pointer" id="dropdownTable" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                    <i class="fa fa-ellipsis-v text-secondary"></i>
                                                </a>
                                                <ul class="px-2 py-3 dropdown-menu me-n4" aria-labelledby="dropdownTable">
                                                    <li><a class="dropdown-item border-radius-md " href="{{ route('posts.edit',$p->id) }}">تعديل <i class="fa fa-edit"></i></a></li>
                                                    <li><a class="dropdown-item border-radius-md" href="{{ route('posts.show',$p->id) }}">عرض <i class="fa fa-eye"></i></a>
                                                    </li>

                                                    <li>
                                                        <form action="{{ route('posts.destroy',$p) }}"
                                                         method="post">
                                                         @method('DELETE')
                                                         @csrf
